...
def get_player_name():
    ...
    if which("avplay"):
        ...
        # should raise exception
        warn(
            "Couldn't find ffplay or avplay - defaulting to ffplay, "
            "but may not work",
            RuntimeWarning,
        )
        return "ffplay"
...
def get_prober_name():
    ...
    if which("avprobe"):
        ...
        # should raise exception
        warn(
            "Couldn't find ffprobe or avprobe - defaulting to "
            "ffprobe, but may not work",
            RuntimeWarning,
        )
        return "ffprobe"
...
def mediainfo(filepath):
    """
    Return dictionary with media info(codec, duration, size,
    bitrate...) from filepath
    """
